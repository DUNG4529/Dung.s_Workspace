...
<span class="topology-title">Command Search</span>
<span class="topology-shortcut">Ctrl + K</span>
</div>
<p class="topology-text">Full-text instant search across all notes, definitions, theorems, and mathematical formulas throughout the entire archive.</p>
</div>

<div class="topology-item">
<div class="topology-header">
<span class="topology-icon">📂</span>
<span class="topology-title">Hierarchical Explorer</span>
<span class="topology-shortcut">Left Sidebar</span>
</div>
<p class="topology-text">A 1:1 structural mirror of the vault filesystem for comprehensive top-down exploration of deep course folders.</p>
</div>
...
<span class="topology-title">Graph & Table of Contents</span>
<span class="topology-shortcut">Right Sidebar</span>
</div>
<p class="topology-text">Interactive knowledge graph showing local associative connections, accompanied by dynamic reading position tracking.</p>
</div>
